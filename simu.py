...
frommain = ["jobs", "players", "enemies", "items", "areas", "party", "encounter", "exit"]
	...
	if movech.lower() == "yes":
		...
		while movemaking == True:
			...
			while effecting == True:
				...
				cont = input("Would you like to add another effect to your move?: ").lower()
				if cont != "yes":
					effecting = False
	...
	if menu == "encounter":
		if party != []:
			if enemies != [] or items != []:
				...
				print("There are no items or enemies.")
		else:
			print("There are no players in the party.")
